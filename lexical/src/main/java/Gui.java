...
public class Gui extends JFrame
{
	...
	public Gui()
	{
		...
		setSize(925,678);    //设置窗口显示尺寸
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);    //置窗口是否可以关闭
		getContentPane().setLayout(null);

		//JScrollpane面板放到contentpane容器里，JScrollpane是打开文件的预览
		...
		final String[] name2 = new String[] {"错误行号", "Token", "详细说明"};
		...
		final String[] name3 = new String[] {"标识符", "位置"};
		...
		final String[] name4 = new String[] {"常量", "位置"};
		...
		button3.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				//将要显示的数据model传入lexical中，同时在lexical中更新GUI
