...
public class Lexical
{
	...
	public static Map<String, Integer> prodChar = new HashMap<>();  // 符号表HashMap
			...
			else 
			{
				...
				for(int i = 0; i < strline.length; i++) 
				{
                    ...
                    {  
                        ...
                        {
                        	if (prodChar.isEmpty() || (!prodChar.isEmpty() && !prodChar.containsKey(token)))
                        	{  
                                prodChar.put(token, symbol_pos);
